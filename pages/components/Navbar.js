		...
		<nav className='text-xl z-10 font-medium relative '>
			<ul className=' flex flex-row flex-nowrap gap-5 my-2	justify-center lg:flex-nowrap  md:flex-wrap sm:flex-wrap'>
				<Link href={'/Ident'}>
					...
					ease-in-out delay-150 bg-violet-700 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-900 duration-300 lg:h-18 lg:p-2 md:h-18 md:p-2 sm:h-18 sm:p-2 xl:h-18 xl:p-2'
					>
						Идентификация
					</button>
				</Link>
