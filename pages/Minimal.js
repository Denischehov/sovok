	...
	return (
		...
		>
			<div className='text-center my-32 lg:my-32 md:my-48 sm:my-72 '>
				<h2 className='border-[1px] hover:text-indigo-200 rounded-xl p-1 text-3xl text-indigo-200 border-indigo-400 '>
					Минимальные требования на ДК или карту халва
				</h2>
				<p className='border-[1px] p-2 hover:text-indigo-200 my-3  hover:border-x-indigo-200 hover:border-y-indigo-400 border-y-gray-500 border-x-gray-200 duration-300 rounded-xl text-xl'>
					Назовите пожалуйста ваше Имя, Фамилию, Отчество и дату рождения.
				</p>
				<p className={`text-indigo-200 content ${show ? 'show' : ''}`}></p>
				<p className='border-[1px] p-3 hover:text-indigo-200 my-3   hover:border-x-indigo-200 hover:border-y-indigo-400 border-y-gray-500 border-x-gray-200 duration-300 rounded-xl text-xl  duration-300'>
					<button className='' onClick={() => setShow(!show)}>
						Вы являетесь гражданином Российской федерации, верно?
					</button>
					<p className={`text-indigo-200 content ${show ? 'show' : ''}`}>
						Нет - презентуй дебетовую карту Халва
					</p>
				</p>

				<p className='border-[1px] p- hover:text-indigo-200 my-3  hover:border-x-indigo-200 hover:border-y-indigo-400 border-y-gray-500 border-x-gray-200 duration-300 rounded-xl text-xl  duration-300'>
					<button onClick={() => setShow1(!show1)}>
						Скажите пожалуйста, имеется ли у вас инвалидность? Если да, то какой
						группы?{' '}
					</button>
					<p className={`text-indigo-200 content ${show1 ? 'show' : ''}`}>
				...
				<p className='border-[1px] p-3 hover:text-indigo-200 my-3  hover:border-x-indigo-200 hover:border-y-indigo-400 border-y-gray-500 border-x-gray-200 duration-300 rounded-xl text-xl  duration-300'>
					...
					<p className={`text-indigo-200 content ${show2 ? 'show' : ''}`}>
				...
				<p className='border-[1px] p-3 hover:text-indigo-200 my-3  hover:border-x-indigo-200 hover:border-y-indigo-400 border-y-gray-500 border-x-gray-200 duration-300 rounded-xl text-xl  duration-300'>
					...
					<p className={`text-indigo-300 content ${show3 ? 'show' : ''}`}>
						<a
							target='_blank'
							rel='noreferrer'
				...
				<p className='border-[1px] p-3 hover:text-indigo-200 my-3  hover:border-x-indigo-200 hover:border-y-indigo-400 border-y-gray-500 border-x-gray-200 duration-300 rounded-xl text-xl  duration-300'>
					...
					<p className={`text-indigo-200 content ${show4 ? 'show' : ''}`}>
				...
				<p className='border-[1px] p-3 hover:text-indigo-200 my-3  hover:border-x-indigo-200 hover:border-y-indigo-400 border-y-gray-500 border-x-gray-200 duration-300 rounded-xl text-xl  duration-300'>
					...
					<p className={`text-indigo-200 content ${show5 ? 'show' : ''}`}>
				...
				<h2 className='border-[1px] hover:text-indigo-200 rounded-xl p-1 text-3xl text-indigo-200 border-y-indigo-300'>
					Работа
				</h2>
				<p className='border-[1px] p-3 hover:text-indigo-200 my-3  hover:border-x-indigo-200 hover:border-y-indigo-400 border-y-gray-500 border-x-gray-200 duration-300 rounded-xl text-xl  duration-300'>
					...
					<p className={`text-indigo-200 content ${show6 ? 'show' : ''}`}>
						Если да:{' '}
				...
				<p className='border-[1px] p-3 hover:text-indigo-200 my-3  hover:border-x-indigo-200 hover:border-y-indigo-400 border-y-gray-500 border-x-gray-200 duration-300 rounded-xl text-xl  duration-300'>
					...
					<p className={`text-indigo-200 content ${show7 ? 'show' : ''}`}>
				...
				<p className='border-[1px] p-3 hover:text-indigo-200 my-3  hover:border-x-indigo-200 hover:border-y-indigo-400 border-y-gray-500 border-x-gray-200 duration-300 rounded-xl text-xl  duration-300'>
					...
					<p className={`text-indigo-200 content ${show8 ? 'show' : ''}`}>
				...
				<p className='border-[1px] p-3 hover:text-indigo-200 my-3  hover:border-x-indigo-200 hover:border-y-indigo-400 border-y-gray-500 border-x-gray-200 duration-300 rounded-xl text-xl'>
					<button> На пенсии состоите? </button>
					<p className='text-indigo-200'>Состоит - с чем связана пенсия?</p>
				</p>
				<p className='border-[1px] p-3 hover:text-indigo-200 my-3  hover:border-x-indigo-200 hover:border-y-indigo-400 border-y-gray-500 border-x-gray-200 duration-300 rounded-xl text-xl  duration-300'>
					<button onClick={() => setShow9(!show9)}>
						Декрет официальный (находится в штате организации){' '}
					</button>
					<p className={`text-indigo-200 content ${show9 ? 'show' : ''}`}>
				...
				<p className='border-[1px] p-3 hover:text-indigo-200 my-3  hover:border-x-indigo-200 hover:border-y-indigo-400 border-y-gray-500 border-x-gray-200 duration-300 rounded-xl text-xl  duration-300'>
					...
					<p className={`text-indigo-200 content ${show10 ? 'show' : ''}`}>
				...
				<footer className=' mt-6  border-[1px] p-3 hover:text-indigo-200 rounded-xl  hover:border-x-indigo-200 hover:border-y-indigo-400 border-y-gray-500 border-x-gray-200 duration-300 text-center p-3'>
					<p>
						Разработчик: Иван Дмитриевич. Контакты:
						<a
							className='hover:text-indigo-200 duration-300 px-2'
						...
						<a
							className='hover:text-indigo-200 duration-300'
